  ...
  return (
    ...
    >
      ...
      <div className="container relative mx-auto max-w-7xl">
              ...
              <div className="flex gap-3">
                {[
                  ...
                  return (
                    ...
                    >
                      <button
                        className="w-9 h-9 cursor-pointer rounded-full flex items-center justify-center transition-all hover:scale-110 text-white bg-slate-800 hover:bg-slate-900"
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <Link href="tel:+91-7037256969">
                  <button
                    className="flex items-center cursor-pointer gap-2 px-4 py-2 rounded-full text-white transition-colors hover:opacity-90 bg-green-600 hover:bg-green-700 font-semibold"
                  >
                    ...
                    <li key={item.name}>
                      {item.path.startsWith("https:") ? (
                        <Link
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group inline-flex items-center gap-1 transition-colors duration-200 text-slate-800 hover:text-green-600 font-medium"
                        >
                          {item.name}
                        </Link>
                      ) : (
        ...
        <div className="h-px w-full my-12 bg-slate-700"></div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-base">
          ...
          <div className="flex gap-6">
            <Link
              ...
              className="transition-colors text-slate-800 hover:text-green-600 font-semibold"
            >
              Privacy Policy
            </Link>
            <Link
